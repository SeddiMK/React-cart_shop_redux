...
export const fetchFurniture = createAsyncThunk(
  ...
  async (params) => {
    ...
    const { data } = await axios.get(
      `https://65c21d61f7e6ea59682aa9c7.mockapi.io/data_shop_furniture?limit=3&page=${currentPage}&sortBy=${sortBy}&order=${order}&search=${searchInpValData}&filter=${searchCategoryFilter}`
