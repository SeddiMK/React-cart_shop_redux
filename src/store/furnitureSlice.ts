...
// export type FetchFurnitureArgs = Record<string, string>;
...
export const fetchFurniture = createAsyncThunk<Furniture[],Record<string, string>>('furniture/fetchFurnitureStatus',async (params) => { // (params:Record<string, string>)
    const {
      sortBy,
      order,
